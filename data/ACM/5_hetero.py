...
* Implementing `Relational-GCN <https://arxiv.org/abs/1703.06103>`_, a popular GNN models,
  for heterogenous graph input.

* Training a models to solve a node classification task.
...
# Create the models. The output has three logits for three classes.
...
#
# * We also provide the following models examples:
#
